 ...
 * @property array $dbRetryOptions Retry policy for queries that fail with a transient error (deadlock, lost connection). See /wire/config.php $config->dbRetryOptions for details. #pw-group-database @since 3.0.272
 * 
