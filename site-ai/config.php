...
// Show placeholders where image fields are empty? (see siteImage() in /site/templates/_func.php)
// true = show to everyone, 'editors' = only users who can edit the page, false = never.
// Consider 'editors' or false once real images have been added.
$config->siteImagePlaceholders = true;
