...
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('97', 'FieldtypeTextarea', 'summary', '0', 'Summary', '{\"description\":\"A short introduction to the page, used in page headers, listings and search engine descriptions.\",\"inputfieldClass\":\"InputfieldTextarea\",\"contentType\":0,\"textformatters\":[\"TextformatterEntities\"],\"rows\":3,\"minlength\":0,\"maxlength\":0,\"showCount\":0}');
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('98', 'FieldtypeTextarea', 'body', '0', 'Body', '{\"inputfieldClass\":\"InputfieldTinyMCE\",\"contentType\":1,\"inlineMode\":0,\"lazyMode\":1,\"features\":[\"toolbar\",\"menubar\",\"stickybars\",\"purifier\",\"imgResize\",\"pasteFilter\"],\"toolbar\":\"styles bold italic pwlink pwimage blockquote hr bullist numlist table anchor code\",\"plugins\":[\"anchor\",\"code\",\"link\",\"lists\",\"pwimage\",\"pwlink\",\"table\"],\"rows\":15,\"minlength\":0,\"maxlength\":0,\"showCount\":0}');
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('99', 'FieldtypeImage', 'image', '0', 'Image', '{\"description\":\"A single image for the page.\",\"extensions\":\"jpg jpeg png gif\",\"maxFiles\":1,\"outputFormat\":2,\"fileSchema\":270,\"textformatters\":[\"TextformatterEntities\"],\"descriptionRows\":1,\"gridMode\":\"grid\",\"focusMode\":\"on\",\"inputfieldClass\":\"InputfieldImage\"}');
...
INSERT INTO `field_summary` (`pages_id`, `data`) VALUES('1', 'A new ProcessWire site, ready to be built.');
...
INSERT INTO `field_body` (`pages_id`, `data`) VALUES('1', '<p>This site was installed with the ProcessWire AI Starter profile. Edit this page in the admin to change this text, or describe the site you want to an AI agent and let it build the fields, templates, pages and design for you.</p>');
INSERT INTO `field_body` (`pages_id`, `data`) VALUES('27', '<p>Sorry, the page you requested could not be found. Try the navigation above, or return to the homepage.</p>');
